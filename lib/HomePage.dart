            ...
            Row(
              children: [
               ...
               Expanded(child:  Padding(
                 ...
                 child: Container(child: Image.asset("images/cloud.jpg" ,width: 530, height: 320 , )),
               ),),
                    ...
                    Text(
                     ...
                     Text(
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(right: 10, left: 6 ,top:4 ),
                          child: Text("read More", style:TextStyle(fontSize:10 ,color:Colors.white )
                          ),
                        )),
                  ]),
                )),
